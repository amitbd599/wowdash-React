...
const useReactApexChart = () => {
    ...
    return { chartSeries, chartOptions, barChartSeries, barChartOptions, donutChartSeries, donutChartOptions, paymentStatusChartSeries, paymentStatusChartOptions, createChart, createChartTwo };
};
